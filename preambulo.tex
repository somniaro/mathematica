...
%\usepackage{fp} % no se usa en el proyecto
%\usepackage{calculus} % no se usa \dint, \dsum, etc.
%\usepackage{calculator} % no se usa \COPY, \ADD, etc.
\usepackage{fancyvrb}
\usepackage{mathtools}
\usepackage{bigints}
%\usepackage{fontawesome} % duplicado; ya cargado arriba
