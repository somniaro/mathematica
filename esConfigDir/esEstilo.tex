...
\titleformat{\section}[block]{\fontssec\sectionbaseformat}{\thesection}{0.5em}{\raggedright}
\titleformat{\subsection}[block]{\fontssubsec\subsectionbaseformat}{\thesubsection}{0.5em}{\raggedright}
\titleformat{\subsubsection}[block]{\fontssubsubsec\subsubsectionbaseformat}{\thesubsubsection}{0.5em}{\raggedright}
\titleformat{\paragraph}[block]{\fontsparagraph\paragraphbaseformat}{\theparagraph}{0.5em}{\raggedright}
...
\newcommand{\pieimagen}[2]{\par\vspace{0.5em}
  \begin{minipage}{0.8\textwidth}\centering\color{MSBlack}\footnotesize\textbf{#1:}~{#2}
\end{minipage}\par}
