...
\vspace{1cm}
	\begin{tabular}{p{0.26\textwidth}!{\vrule width 0.9pt}p{0.69\textwidth}}
		...
		\fontsize{9pt}{9pt}\selectfont{Zambrano Caviedes, J. y Baquero Torres, E. (2026). \emph{Problemas resueltos de integración múltiple con aplicaciones en Wolfram Mathematica.} Universidad Distrital Francisco José de Caldas-Editorial UD. DOI: XXXX}\\
	\end{tabular}
