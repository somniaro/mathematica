...
superficies o sólidos cuyas generalidades se presentaron en la sección (\ref{regionesparametrizadas}). \index{Parametrización}
...
De acuerdo con \cite{marsden_calculo_2013}, una curva $C$ en $\mathbb{R}^n$ es la imagen de una funci\'{o}n
...
\vskip0.3cm 
Si $g:[c,d]\rightarrow \lbrack a,b]$ es una funci\'{o}n biyectiva y continua en $[c,d]$
tal que $\alpha =r\circ g, \,$ a $\alpha,$ se le denomina una \emph{reparametrizaci\'{o}n} de $\ve{r}.$
Si la funci\'{o}n $g$ es creciente $\left(g^{\prime }(t)>0\right), $
entonces $\alpha $ preserva la orientaci\'{o}n, y si $g$ es decreciente
$\left( g^{\prime }(t)<0\right), $ entonces $\alpha $ invierte la orientaci\'{o}n de la curva.
\vskip0.1cm
...
Para dos puntos $a$ y $b$ en $\mathbb{R}^{n},$  la funci\'{o}n 
...
Para dos puntos $P$ y $Q$ en $\mathbb{R}^n$, si $f$ y $g$ son dos funciones cont\'{i}nuas en $[a,b]$ tales que 
$f(a)=1,$ $g(a)=0$ y $f(b)=0,$ $g(b)=1,$ entonces la funci\'{o}n
\begin{equation}
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.20\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_53a.eps}
	\end{minipage}
	\begin{minipage}{0.30\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_53b.eps}
	\end{minipage}
	\begin{minipage}{0.30\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_53c.eps}
	\end{minipage}
...
\textcolor{black}{\scriptsize\ding{110}}\quad Las expresiones $2z=x^{2}-y^{2}$ y $2x^{2}+y^{2}+2y=8$ representan un paraboloide hiperb\'{o}lico y un cilindro elíptico, respectivamente. La ecuaci\'{o}n
del cilindro representa una elipse en el plano $xy$, el interior de esta región 
se parametriza como $x=\frac{3}{\sqrt{2}}u\cos (t),$ $y=-1+3u\sin (t),$ con la ecuación del paraboloide hiperb\'{o}lico 
se halla $z$, esto es 
...
hiperb\'{o}lico acotada por el cilindro.
\vskip0.2cm
\noindent
\begin{minipage}{\textwidth}
	\centering
	...
	\begin{minipage}{0.23\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/73a.eps}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}{0.23\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/73b.eps}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.26\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/86a.eps}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}{0.33\linewidth}
		\centering
...
Mientras que la intersecci\'{o}n del paraboloide y el plano $z=0$ se parametriza como $x=6\sin (t) $, $y=6\cos (t) $, con $t\in \lbrack 0,2\pi ].$
...
la silla de montar con ecuaci\'{o}n  $5z=x^{2}-y^{2},$ exterior al cilindro con ecuación 
...
funciones reales cont\'{i}nuas en el intervalo $[a,b]$, que satisfacen que 
$f(a)=1,$ $g(a)=0$ y $f(b)=0,$ $g(b)=1,$ entonces la funci\'{o}n vectorial
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.23\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/42a.eps}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/42b.eps}
	\end{minipage}
...
que representan dos elipses en el espacio, se forma una combinaci\'{o}n convexa de ellas con par\'{a}metro 
$u\in \lbrack 0,1].$
\\
Simplificando la expresión $(1-u)\overrightarrow{r}_1(t)+u\overrightarrow{r}_2(t)$
se obtiene la funci\'{o}n:
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.17\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/33a.eps}
	\end{minipage}
	\begin{minipage}{0.17\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/33b.eps}
	\end{minipage}
	\begin{minipage}{0.17\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/33c.eps}
	\end{minipage}
...
\begin{figure}[H]
	\begin{center}
		...
		\includegraphics[width=2.75cm,height=1.5cm]{Img/8c.eps}
		\includegraphics[width=2.75cm,height=1.5cm]{Img/8b.eps}
		\includegraphics[width=2.75cm,height=1.5cm]{Img/8a.eps}
	\end{center}
	\parbox{0.95\linewidth}{\centering\fontsize{8pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{figure}
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.30\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/69a.eps}
	\end{minipage}
...
\begin{figure}[H]
	\begin{center}
		...
		\includegraphics[scale=0.33]{Img/78c.eps}
		\includegraphics[scale=0.33]{Img/78a.eps}
		\includegraphics[scale=0.33]{Img/78b.eps}
	\end{center}
...
Al hacer coincidir el eje vertical con el eje $z,$ entonces la funci\'{o}n que describe la superficie en menci\'{o}n, para $t\in \lbrack 0,2\pi ],$ $u\in \lbrack 0,1],$ es
\[
\resizebox{\textwidth}{!}{$
...
\begin{figure}[H]
	...
	\vspace{2pt} 
	\includegraphics[width=0.21\linewidth]{Img/49a.eps} \hspace{1em}
	\includegraphics[width=0.21\linewidth]{Img/49b.eps} \hspace{1em}
...
representan gr\'{a}ficamente un paraboloide y un paraboloide hiperb\'{o}lico, al 
eliminar $y$ de estas expresiones se obtiene la ecuaci\'{o}n $9x^{2}+16z^{2}=18,$ que corresponde a una elipse en el plano $xz.$ La regi\'{o}n interior a esta curva se parametriza como 
$x=\sqrt{2}u\cos (t) ,$ $z=\frac{3\sqrt{2}}{4}u\sin (t) ,$ para $t\in \lbrack 0,2\pi ],$ $u\in \lbrack 0,1].$ Al reemplazar estas expresiones en las ecuaciones del paraboloide y del paraboloide hiperb\'{o}lico, se obtiene:
\[
...
\begin{figure}[H]
	...
	\begin{minipage}[b]{0.28\linewidth}
		...
		\includegraphics[width=\linewidth, height=3.0cm, keepaspectratio]{Img/71b.eps}
	\end{minipage}
	\hfill
	\begin{minipage}[b]{0.28\linewidth}
		\centering
		\includegraphics[width=\linewidth, height=3.0cm, keepaspectratio]{Img/71d.eps}
	\end{minipage}
	\hfill
	\begin{minipage}[b]{0.28\linewidth}
		\centering
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.24\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/43b.eps}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}{0.24\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/43a.eps}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.24\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/46a.eps}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}{0.24\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/46b.eps}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.23\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/47b.eps}
	\end{minipage}
	\begin{minipage}{0.23\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/47a.eps}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.24\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/45a.eps}
	\end{minipage}
	\begin{minipage}{0.24\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/45b.eps}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.23\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/1a.eps}
	\end{minipage}
	\begin{minipage}{0.28\linewidth}
		\centering
...
Se puede representar la porci\'{o}n del plano con ecuaci\'{o}n $6z=2x+y+12$ sobre la región acotada  por los dos cilindros. 
...
\begin{figure}[H]
	...
	\includegraphics[width=0.28\linewidth, height=3cm, keepaspectratio]{Img/1c.eps}
	\hspace{1cm} % Espacio horizontal entre ambas
	\includegraphics[width=0.28\linewidth, height=3cm, keepaspectratio]{Img/1d.eps}
...
Con ayuda de la expresi\'{o}n (\ref{1a}), se puede parametrizar la parte del
parabo- \\ loide con ecuaci\'{o}n $z=6-\left( x-1\right) ^2-y^2,$ cuya proyecci\'{o}n 
en el plano $xy$ es la regi\'{o}n $R,$ para este fin determinaremos $z$, esto es
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.23\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/1e.eps}
	\end{minipage}
	\begin{minipage}{0.23\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/1f.eps}
	\end{minipage}
	\begin{minipage}{0.28\linewidth}
		\centering
...
% Las curvas de intersecci\'{o}n de los cilindros elípticos y el paraboloide se determinan reemplazando en el valor 
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.24\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/4a.eps}
	\end{minipage}
	\hspace{1em} 
	\begin{minipage}{0.24\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/4b.eps}
	\end{minipage}
...
en una curva con ecuaci\'{o}n cartesiana 
...
\begin{figure}[h!]
	...
	\includegraphics[scale=0.20]{Img/4c.eps} \hspace{0.5cm} 
	\includegraphics[scale=0.35]{Img/4d.eps} 
	\parbox{0.95\linewidth}{\centering\fontsize{8pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		...
		\includegraphics[width=3.5cm,height=3.25cm]{Img/2a.eps}\hspace{0.5cm}
		\includegraphics[width=3.5cm,height=3.25cm]{Img/2b.eps}
		\parbox{0.95\linewidth}{\centering\fontsize{8pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
	\end{center}
\end{figure}
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.24\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/2c.eps}
	\end{minipage}
	\begin{minipage}{0.24\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/2d.eps}
	\end{minipage}
...
\begin{minipage}{\textwidth} % <--- MINIPAGE: Fija la figura al flujo de texto
	\centering % <--- \centering es más compacto que \begin{center}
		...
		\includegraphics[width=2.8cm,height=2.90cm]{Img/2e.eps}\hspace{1cm}
		\includegraphics[width=2.8cm,height=2.9cm]{Img/2f.eps}
		\parbox{0.95\linewidth}{\centering\fontsize{8pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
	\end{minipage}
...
\begin{figure}[H]
	...
	\begin{minipage}[b]{0.24\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/2g.eps}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}[b]{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/2h.eps}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}[b]{0.24\linewidth}
		\centering
...
\begin{figure}[H]
	...
	\includegraphics[width=0.23\linewidth]{Img/74c.eps}\hspace{3mm}
...
Entonces, los puntos sobre el cono (dentro del s\'{o}lido) se determinan por
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.26\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/74a.eps}
	\end{minipage}
	\begin{minipage}{0.26\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/74b.eps}
	\end{minipage}
...
describen el s\'{o}lido que se muestra a continuaci\'{o}n.
...
El paraboloide se proyecta en el plano $xy$ como una circunferencia con ecuaci\'{o}n $x^{2}+y^{2}=9,$
la proyecci\'{o}n del s\'{o}lido en plano $xy$ contiene a los puntos interiores a una circunferencia y exteriores a la otra.
...
\end{eqnarray*}
El s\'{o}lido se parametriza formando segmentos rectilíneos que unen a $P$
con $Q,$ esto se logra mediante la combinación convexa $(1-v)P+vQ,$
en donde $Q$ tiene la forma
$Q(u+(3-2u)\cos(2t),(3-2u)\sin(2t),u (12-5 u+2(2u-3)\cos(2t))).$ Esto nos lleva a definir la funci\'{o}n 
...
tres planos. Estas superficies acotan un s\'{o}lido $E,$
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.22\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/5a.eps}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}{0.22\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/5c.eps}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}{0.22\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/5b.eps}
	\end{minipage}
...
\includegraphics[scale=0.42]{Img/76b.eps} 
\includegraphics[scale=0.38]{Img/76a.eps}
\includegraphics[scale=0.42]{Img/76c.eps}
\end{center}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{11pt}\selectfont{\bf Fuente:} elaboración propia.}
\end{figure}
...
\begin{center}
	\captionof{figure}{\small Gráfico de ${\bf r}\left(t,u,w\right)$}
\includegraphics[scale=0.35]{Img/77a.eps} 
\includegraphics[scale=0.37]{Img/77b.eps}
\end{center}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{11pt}\selectfont{\bf Fuente:} elaboración propia.}
\end{figure}
...
t\right) \right) \sin (t) ,0\right\rangle $. El s\'{o}lido
que se genera mediante una combinaci\'{o}n convexa de los puntos de esta regi\'{o}n 
...
\includegraphics[scale=0.4]{Img/75a.eps} 
\includegraphics[scale=0.4]{Img/75b.eps}
\includegraphics[scale=0.45]{Img/75c.eps}
\end{center}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		...
		\includegraphics[scale=0.44]{Img/T_71a.eps}
	\end{center}
	\parbox{0.95\linewidth}{\centering\fontsize{8pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{figure}
\vspace{-5mm}
...
\includegraphics[scale=0.30]{Img/T_71b.eps} \hskip0.5cm
\includegraphics[scale=0.30]{Img/T_71c.eps}
\end{center}
\parbox{0.95\linewidth}{\centering\fontsize{8pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.17\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_56a.eps}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}{0.17\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_56b.eps}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.22\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_39a.eps}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.14\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_38a.eps}
	\end{minipage}
