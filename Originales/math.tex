...
\end{Verbatim}
      ...
      (4) La región del espacio interior a la esfera $x^2+y^2+z^2=4$ y al hiperboloide de dos mantos $x^2+y^2=2+z^2$, exterior al cilindro $x^2+y^2=\frac{2}{5}$ se muestra en la siguiente figura.
...
\end{Verbatim}
      ...
      $0.2$ respectivamente, se obtiene la siguiente figura.
      ...
      La figura anterior se obtiene al ejecutar las siguientes sentencias.
