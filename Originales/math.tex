...
Las operaciones básicas: adición, sustracción, producto y cociente, entre dos cantidades $x$ e $y$ se denotan respectivamente como \verb"x+y", \verb"x-y", \verb"x*y" y \verb"x/y". \vskip0.1cm
...
\verb"I", la unidad imaginaria $i$, $i^{2}= -1;$ \verb"Infinity", $\infty$.\vskip0.1cm

\noindent Las funciones trigonométricas\footnote{Con argumento en radianes} se denotan como
{\small
...
\end{tcolorbox}
% Al no definir la función en un conjunto el valor por defecto es $0.$ \vskip0.2cm
...
se puede hacer una lista con estas y encerrarlas en llaves (\verb"{...}").\vskip0.2cm
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.27\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/math_01a.eps}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}{0.27\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/math_01b.eps}
	\end{minipage}
...
La instrucci\'{o}n \verb"Graphics[Point[{a,b}]]" dibuja el punto de
...
\begin{figure}[H]
	\begin{center}
		\captionof{figure}{\small El vector $\langle 1,1,1\rangle$ se dibuja en el punto $(1,1,-1)$.}
		\includegraphics[scale=0.32]{Img/T_67a.eps} \hskip0.2cm
		\includegraphics[scale=0.32]{Img/T_67b.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
	\end{center}  
\end{figure}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{\small Uso de la función {\tt RegionPlot}}
	\begin{minipage}{0.12\linewidth}
		\centering
		\vspace{-2mm}
		\includegraphics[width=\linewidth]{Img/T_49a.eps}
	\end{minipage}
	\begin{minipage}{0.12\linewidth}
	\centering
	\vspace{-2mm}
	\includegraphics[width=\linewidth]{Img/T_49b.eps}
	\end{minipage}
	\begin{minipage}{0.12\linewidth}
	\centering
	\vspace{-2mm}
	\includegraphics[width=\linewidth]{Img/T_49c.eps}
	\end{minipage}
	\begin{minipage}{0.12\linewidth}
		\centering
		\vspace{-2mm}
		\includegraphics[width=\linewidth]{Img/T_49d.eps}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.14\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/math_06c-eps-converted-to}
	\end{minipage}
	\hspace{1em} 
	\begin{minipage}{0.14\linewidth}
		\centering		
		\includegraphics[width=\linewidth]{Img/math_06d-eps-converted-to}
	\end{minipage}
...
\begin{center}
	\captionof{figure}{\small Sólido acotado por $x^2+2x+y^2=0,$ $x^2+y^2-3x=\frac{7}{4},$ $2z+y=4.$}
	\includegraphics[scale=0.17]{Img/math_06.eps} \hspace{0.2cm}  
	\includegraphics[scale=0.17]{Img/math_06a.eps} \hspace{0.2cm}
	\includegraphics[scale=0.17]{Img/math_06b.eps}
	\vspace{0.5em}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\vskip0.2cm
\end{center}
...
\begin{figure}[H]
	\begin{center}
		\captionof{figure}{\small Superficie determinada por $(x^2+y^2)^2=z+1$ y $z= 4(1-x^2-y^2)$.}
		\includegraphics[scale=0.17]{Img/math_06e.eps} \hspace{0.3cm}
		\includegraphics[scale=0.17]{Img/math_06f.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\vskip0.2cm
\end{center}
\end{figure}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{\small Sólido acotado por $x^2+y^2+z^2=4,$ $x^2+y^2=2+z^2,$ $x^2+y^2=\frac{2}{5}.$}
	\begin{minipage}{0.17\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/math_06n.eps}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}{0.17\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/math_06p.eps}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{\small Sólido acotado por $1 \leq r \leq 2,$ $r \leq z \leq 2.$}
	\begin{minipage}{0.17\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/math_06g.eps}
	\end{minipage}
	\begin{minipage}{0.17\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/math_06h.eps}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{\small Regiones en coordenadas esféricas.}
	\begin{minipage}{0.17\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/math_06aa.eps}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}{0.13\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/math_06ab.eps}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}{0.17\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/math_06ac.eps}
		\label{regiones_esfe}
	\end{minipage}
...
\vskip0.2cm
 ...
 \begin{minipage}{\textwidth}
 	\centering
 	\captionof{figure}{\small Región determinada por $1\leq \rho \leq 2,$ $0\leq \theta\leq \frac{3\pi}{4}$ y $\frac{\pi}{6} \leq \phi \leq \frac{3\pi}{4}$}
 	\begin{minipage}{0.15\linewidth}
 		\centering
 		\includegraphics[width=\linewidth]{Img/math_06m.eps}
 	\end{minipage}
 	\hspace{1em}
 	\begin{minipage}{0.15\linewidth}
 		\centering
 		\includegraphics[width=\linewidth]{Img/math_06l.eps}
 	\end{minipage}
 	\hspace{1em}
 	\begin{minipage}{0.16\linewidth}
 		\centering
 		\includegraphics[width=\linewidth]{Img/math_06k.eps}
 	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{\small Región determinada por $1\leq\rho\leq 2,$ $0\leq\theta\leq 3\pi/2,$ $\pi/4\leq\phi\leq 5\pi/6.$}
	\begin{minipage}{0.17\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_50a.eps}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}{0.17\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_50b.eps}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{\small Superficies con restricciones en el espacio.}
	\begin{minipage}{0.17\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_47a.eps}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}{0.23\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_48a.eps}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{\small Función $f(x)=4-x+3x^2-x^3$.}
	\begin{minipage}{0.20\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_43b.eps}
	\end{minipage}
	\hspace{1em} 
	\begin{minipage}{0.20\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_43a.eps}
	\end{minipage}
...
\begin{figure}[H]
	\begin{center}
		\captionof{figure}{\small Función $f(x,y)=2+xy-x^2-y^3$.}
		\includegraphics[scale=0.25]{Img/T_44a.eps}
		\includegraphics[scale=0.25]{Img/T_44b.eps}
		\includegraphics[scale=0.25]{Img/T_44c.eps}
	\end{center}
	\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{figure}
...
\noindent % Asegura alineación con el margen izquierdo
\begin{minipage}{\textwidth}
	\centering
	% Se usa \captionof porque minipage no es un entorno flotante
	\captionof{figure}{\small Función $f(x,y)=3+xy-x^2-y^3$.}
	\label{fig:funcion_T45}
	
	\vspace{0.3cm}
	% Imágenes con escala homogénea (0.30) según tu solicitud
	\includegraphics[scale=0.20]{Img/T_45a.eps} \hskip0.5cm
	\includegraphics[scale=0.20]{Img/T_45b.eps}
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.24\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_46a.eps}
	\end{minipage}
	\begin{minipage}{0.24\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_46b.eps}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{\small Superficie generada por ${\bf r}(t)= \langle 1 - \cos(t), \sin(t), t - t^2\rangle.$}
	\begin{minipage}{0.21\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/math_06ad.eps}
	\end{minipage}
	\begin{minipage}{0.20\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/math_06ae.eps}
	\end{minipage}
...
\vskip0.2cm 
\textls[-10]{Para obtener una combinaci\'{o}n lineal $f(x),$ de las funciones 
...
combinaci\'{o}n lineal de las funciones $1,x^{2},x^{3},x^{5}$ que mejor
ajustan estos puntos y se presenta su gr\'{a}fico.
\begin{tcolorbox}[breakable,enhanced]
\begin{Verbatim}[formatcom=\letraverbatim]
...
\end{Verbatim}
\end{tcolorbox}
Los siguientes tres ejemplos ilustran el uso de esta funci\'{o}n dos y tres
...
el polinomio de interpolación y se presenta su gr\'{a}fico
\begin{tcolorbox}[breakable,enhanced]
\begin{Verbatim}[formatcom=\letraverbatim]
...
aparecen algunas derivadas parciales de una función que depende de más de una variable. \vskip0.2cm
El \emph{orden} de la ecuación diferencial corresponde al orden de la mayor derivada involucrada.
Una \emph{solución} de la ecuación diferencial es una función definida en un conjunto abierto $I$, tal que para todo $x\in I$ sus derivadas existen y al reemplazarse en la ecuación diferencial la expresión es una identidad.\vskip0.2cm
...
\begin{figure}[H]
	\begin{center}
		\captionof{figure}{\small Campo vectorial $\la \frac{-x+y}{\sqrt{x^2+y^2}}, \frac{x-y}{\sqrt{x^2+y^2}} \ra$.}
		\includegraphics[scale=0.45]{Img/T_55a.eps} \hspace{0.5cm}
		\includegraphics[scale=0.45]{Img/T_55b.eps}
		\parbox{0.95\linewidth}{\centering\fontsize{10pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
	\end{center}
\end{figure}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{\small Campo vectorial ${\bf F}(x,y,z)= \la y,-x,x+z \ra$.}
	\begin{minipage}{0.18\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_28a.eps}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}{0.18\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_28b.eps}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{\small Campo vectorial ${\bf F}(x,y,z)= \la -y,x,z/2 \ra$.}
	\begin{minipage}{0.19\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_27a.eps}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}{0.19\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_27b.eps}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{\small Campo vectorial ${\bf F}(x,y,z) =\la x+z,y,2x-z \ra$.}
	\begin{minipage}{0.21\linewidth}
		\centering
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{\small Campo vectorial ${\bf F}(x,y,z) =\la x-z,y,z+2 \ra$.}
	\begin{minipage}{0.22\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_54a.eps}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}{0.22\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_54b.eps}
	\end{minipage}
