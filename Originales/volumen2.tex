...
Evaluar {\small $\ds \iiint_{E}6xydV$,} en donde $E$ es el sólido acotado por las figuras de las ecuaciones $z=1+x+y,\,\, y=\sqrt{x},\, x=1,\,\,z=0,\,\, y=0$. La figura~\ref{fig:solido_parabolico_inclinado} muestra la región en mención.
...
Las siguientes instrucciones permiten obtener la figura del sólido (figura~\ref{fig:cilindro_parabolico_superior}).
...
Otra manera de hallar este valor es la siguiente. La elipse y su interior se parametrizan como $x=\sqrt{3}u\cos \theta$, $y=2u\sin \theta $, con $u \in [0,1]$, $\theta \in [0,2\pi]$. Reemplazando estas expresiones en las ecuaciones de los paraboloides se sigue que
