...
\begin{minipage}{\textwidth}
	...
	\begin{tabular}{ccc}
		...
		\includegraphics[scale=0.31]{Img/T_51a.eps} & 
		\includegraphics[scale=0.28]{Img/T_51b.eps} &
		\includegraphics[scale=0.28]{Img/T_51c.eps} \\
...
\begin{figure}[H] 
	...
	\begin{minipage}[b]{0.22\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_52a.eps}
	\end{minipage}%
	\begin{minipage}[b]{0.22\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_52b.eps}
	\end{minipage}%
	\begin{minipage}[b]{0.22\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_52c.eps}
	\end{minipage}%
	\begin{minipage}[b]{0.22\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_52d.eps}
	\end{minipage}
	\fuente{elaboración propia.} 
\end{figure}
