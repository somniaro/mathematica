...
\label{Fig/6.png}
\includegraphics[width=0.45\textwidth]{Fig/6.png}
\fuentepropia
\end{figure}
...
l\'{\i}mite de las aproximaciones a través de sumas de Riemann, posteriormente
se presentarán de manera similar las integrales triples. 
La evaluación de las integrales dobles o triples se puede obtener
utilizando el teorema fundamental de cálculo; véase \cite{apostol_calculus_1999}.
...
subdividiremos a $R$ en $nm$ rectángulos más peque\~{n}os a partir
...
Si el l\'{\i}mite de las sumas $S_{nm}$ existe sin importar la selección
...
volumen del paralelep\'{\i}pedo con área de la base $\Delta x_{i}\Delta y_{k}$ y altura $f(x_{i}^{\ast },y_{k}^{\ast });$
...
\includegraphics[width=0.55\textwidth]{Fig/7.pdf} \\
\includegraphics[width=0.55\textwidth]{Fig/8.pdf}
\fuentepropia
\end{figure}
...
subdividiremos a $E$ en $lnm$ cajas rectangulares más peque\~{n}as a
...
De manera similar a como se definió la integral doble, si el l\'{\i}mite de
...
$\ds\iiint\limits_{E}f(x,y,z) dV$ o también $\ds \iiint\limits_{E}f(x,y,z) dzdydx.$ Lo anterior nos
...
\includegraphics[width=0.4\textwidth]{Fig/13.pdf} \hspace{5mm}
