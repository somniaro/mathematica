...
Presentamos algunos problemas relativos a las integrales dobles, cuyos principales elementos teóricos se presentaron en la sección \ref{integralesdobles}.
...
\begin{center}
\captionof{figure}{$f(x,y)=6-\frac{1}{4}x^{3}-y^{2}.$}
\includegraphics[scale=0.35]{Img/T_69c.eps}
\includegraphics[scale=0.34]{Img/T_69b.eps}
\includegraphics[scale=0.36]{Img/T_69a.eps}
...
\vskip0.2cm
\begin{center}
\captionof{figure}{$f(x,y)=3-x^{2}y$}
\includegraphics[scale=0.34]{Img/T_70a.eps}
\includegraphics[scale=0.33]{Img/T_70b.eps}
\includegraphics[scale=0.34]{Img/T_70c.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{11pt}\selectfont{\bf Fuente:} elaboración propia.}
\end{center}
...
\vskip1cm
\begin{center}
\captionof{figure}{$f(x,y)=x^2 \sin (2y)+y^2 \cos (x)$}
\includegraphics[scale=0.32]{Img/T_68a.eps}
\includegraphics[scale=0.30]{Img/T_68b.eps}
\includegraphics[scale=0.30]{Img/T_68c.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{11pt}\selectfont{\bf Fuente:} elaboración propia.}
\end{center}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{$y=x,$ $x^{2}+y^{2}=4$}
	\begin{minipage}{0.38\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/83.pdf}
	\end{minipage}
...
\begin{center}
	\captionof{figure}{$x\leq y \leq \sqrt{4-x^{2}}$}
	\includegraphics[width=0.38\linewidth]{Fig/84.pdf}
	\includegraphics[width=0.38\linewidth]{Fig/85.pdf}
	\parbox{0.95\linewidth}{\centering\fontsize{8pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{$2 \leq r \leq 2 \sec \theta.$}
	\begin{minipage}{0.38\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/86.pdf}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{$\sqrt{x^2-2x}\leq y \leq \sqrt{4-x^2}$}
	\begin{minipage}{0.38\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/87.pdf}
	\end{minipage}
...
\begin{center}
	\captionof{figure}{$2\cos \theta \leq r \leq 2$}
	\includegraphics[width=0.3\linewidth]{Fig/88.pdf}
	\includegraphics[width=0.3\linewidth]{Fig/89.pdf}
	\includegraphics[width=0.3\linewidth]{Fig/90.pdf}
	\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{$2\sin \theta \leq r \leq 2$}
	\label{fig510}
	\begin{minipage}{0.33\linewidth}
		\centering
		\vspace{-2mm}
		\includegraphics[width=\linewidth]{Fig/91.pdf}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{$\csc \theta \leq r \leq 2,$ $\frac{\pi}{6} \leq\theta \leq \frac{\pi}{3}$}
	\begin{minipage}{0.32\linewidth}
		\centering
		\vspace{-4mm}
		\includegraphics[width=\linewidth]{Fig/95.pdf}
	\end{minipage}
...
\begin{center} 
	...
	\parbox{\linewidth}{
		...
		\vspace{0.1em} % Espacio mínimo entre leyenda e imágenes
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{$0 \leq r \leq 2\sqrt{2}.$}
	\begin{minipage}{0.37\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/99.pdf}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{$x^2+2x-2 \leq y \leq 2-x^2$}
	\begin{minipage}{0.38\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/103.pdf}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{$x^2+y^2=4$}
	\begin{minipage}{0.38\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/106.pdf}
	\end{minipage}
...
De acuerdo al teorema de Green, véase sección \ref{teoremadegreen}, el área $A$, de la región $R$ encerrada por la curva $C,$ puede hallarse por medio de la expresión
...
\vspace{-5mm}
\begin{center}
	\captionof{figure}{${\bf r}(t)=\langle 2a\cos t-a\sin (2t),b\sin t\rangle,$ $t\in [0,2\pi ]$}
\includegraphics[width=0.4\linewidth]{Fig/110.pdf}
...
%\vskip0.1cm
Para evaluar integrales dobles, es posible plantear un cambio de variable; la fundamentación teórica de este proceso se presentó en la sección \ref{cambioidobles}.
\section{
...
\vskip0.2cm
\begin{center}
\captionof{figure}{${\bf T}(u,v)= (\sqrt{uv},\sqrt{\frac{u}{v}})$}
\includegraphics[width=0.45\linewidth]{Fig/113.pdf}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\begin{center}
	\captionof{figure}{${\bf T}(u,v)= (\sqrt[4]{\frac{u}{v}},\sqrt{uv})$}
	\includegraphics[width=0.44\linewidth]{Fig/114.pdf}
	\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont{\bf Fuente:} elaboración propia.}
\end{center}
...
\begin{center}
	\captionof{figure}{${\bf T}(u,v)= (u\cosh v, \frac{u}{\sqrt{3}}\sinh v)$}
	\vspace{0.8em} 
	\begin{minipage}[b]{0.41\linewidth}
		\centering
		\includegraphics[width=1.0\linewidth]{Fig/115.pdf}
	\end{minipage}%
	\hspace{1em}
	\begin{minipage}[b]{0.41\linewidth}
		\centering
		\includegraphics[width=1.0\linewidth]{Fig/116.pdf}
	\end{minipage}
...
\begin{center}
\captionof{figure}{\small ${\bf T}(u,v)= \left(\frac{u - v}{2},\, \frac{u + v}{2}\right)$}
\begin{minipage}[b]{0.46\linewidth}
    \centering
    \includegraphics[width=\linewidth]{Fig/117.pdf}
\end{minipage}
\hspace{1em}
\begin{minipage}[b]{0.32\linewidth}
    \centering
    \includegraphics[width=\linewidth]{Fig/118.pdf}
\end{minipage}
...
\begin{center}
\captionof{figure}{${\bf T}(u,v)= (x,y)$}
\includegraphics[width=0.38\linewidth]{Fig/123.pdf}
...
\begin{center}
\captionof{figure}{${\bf T}(u,v)= (x,y)$}
\includegraphics[width=0.55\linewidth]{Fig/124.pdf}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\normalfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.31\linewidth}
		\centering
		\vspace{-3mm}
		\includegraphics[width=\linewidth]{Fig/125.pdf}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}{0.31\linewidth}
		\centering
		\vspace{-3mm}
		\includegraphics[width=\linewidth]{Fig/126.pdf}
	\end{minipage}
...
\begin{center}
	\captionof{figure}{Esfera y dos cilindros}
	\begin{minipage}{0.21\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/6g.eps}
	\end{minipage}
	\hspace{0.02\linewidth}
	\begin{minipage}{0.21\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/6a.eps}
	\end{minipage}
	\hspace{0.02\linewidth}
	\begin{minipage}{0.21\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/6b.eps}
	\end{minipage}
...
%\clearpage
\begin{center}
	\captionof{figure}{Curva de intersección de la esfera y los cilindros}
\includegraphics[scale=0.18]{Img/6f.eps}
\includegraphics[scale=0.20]{Img/6c.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\begin{center}
	...
	\begin{minipage}{0.21\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/6d.eps}
	\end{minipage}
	\hspace{0.02\linewidth}
	\begin{minipage}{0.21\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/6e.eps}
	\end{minipage}
	\hspace{0.02\linewidth}
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/127.pdf}
	\end{minipage}
...
\vspace{-4mm}
\begin{center}
	\captionof{figure}{\small Cilindro cardiogénico y paraboloide}
	
	\includegraphics[width=0.23\linewidth]{Img/40a.eps}
	\hspace{0.5cm} 
	\includegraphics[width=0.23\linewidth]{Img/40b.eps}
...
\vspace{-5mm}
\begin{center}
	\captionof{figure}{Superficie sobre el cilindro cardiogénico acotada por el paraboloide}
	\begin{minipage}{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/128.pdf}
	\end{minipage}
	\hspace{0.02\linewidth}
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/39c.eps}
	\end{minipage}
	\vspace{0.5em}
	\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\vspace{-8mm}
\begin{center}
	\captionof{figure}{Superficie sobre el paraboloide $3z=9-x^{2}-y^{2}$}
	\begin{minipage}{0.29\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/129.pdf}
	\end{minipage}
	\hspace{0.02\linewidth}
	\begin{minipage}{0.29\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/130.pdf}
	\end{minipage}
...
\par 
\noindent
La coordenada $z$ se obtiene reemplazando $x$ y $z$ en la ecuación del parabo- \\ loide, esto es
\vspace{-1.5ex}
{\small
\begin{align*}
...
\begin{figure}[H]
	...
	\begin{minipage}[t]{0.29\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Img/41a.eps}
	\end{minipage}
	\hspace{0.02\linewidth}
	\begin{minipage}[t]{0.29\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Img/41b.eps}
	\end{minipage}
...
\vskip0.9cm
\begin{center}
\captionof{figure}{cilindro $4x^{2}+z^{2}=4$ acotado por dos planos}
\includegraphics[scale=0.30]{Img/55d.eps}
\includegraphics[scale=0.29]{Img/55c.eps}
\includegraphics[scale=0.29]{Img/55b.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\begin{eqnarray*}
\overrightarrow{a}(t)&=&\l \cos(t),\sin(t)-\frac{3}{2},2\sin (t)\ra, \, t\in [0,2\pi] \\
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Superficies sobre el cilindro cardiogénico y sobre el plano \( z = 2 - \frac{x}{2} \)}
	\begin{minipage}{0.32\linewidth}
		\centering
		\vspace{-6mm}
		\includegraphics[width=\linewidth]{Fig/134.pdf}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}{0.32\linewidth}
		\centering
		\vspace{-6mm}
		\includegraphics[width=\linewidth]{Fig/135.pdf}
	\end{minipage}
	\vspace{0.3em}
...
\begin{figure}[H]
	...
	\begin{minipage}[t]{0.28\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/36b.eps}
	\end{minipage}
	\vspace{1ex}
	\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{figure}
...
\includegraphics[scale=0.32]{Img/57a.eps}
\includegraphics[scale=0.32]{Img/57b.eps}
\parbox{0.95\linewidth}{\centering\fontsize{8pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\vspace{0.5em} % espacio entre texto y código
...
\vspace{2mm}
\begin{center}
\captionof{figure}{Cono oblicuo truncado}
\includegraphics[scale=0.26]{Img/19a.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
%\vspace{20mm}
\begin{center}
	\captionof{figure}{Superficie que conecta dos elipses.}
	\begin{minipage}[t]{0.30\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/139.pdf}
	\end{minipage}
	\hfill
	\begin{minipage}[t]{0.30\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Img/20a.eps}
	\end{minipage}
	\hfill
	\begin{minipage}[t]{0.30\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Img/20b.eps}
	\end{minipage}
...
\vspace{-4mm}
\begin{center}
	\captionof{figure}{Cono cardiogénico oblicuo truncado}
	\begin{minipage}[t]{0.26\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/140.pdf}
	\end{minipage}
	\hfill
	\begin{minipage}[t]{0.26\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Img/21a.eps}
	\end{minipage}
	\hfill
	\begin{minipage}[t]{0.26\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Img/21b.eps}
	\end{minipage}
...
\begin{center}
	\captionof{figure}{La flor $r=3\sin(3\theta)$ sobre una esfera}
	\begin{minipage}[t]{0.32\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/141.pdf}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}[t]{0.30\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Img/48a.eps}
	\end{minipage}
...
\begin{center}
\captionof{figure}{La flor $r=3\sin(3\theta)$ sobre una esfera}
\includegraphics[scale=0.39]{Img/68a.eps}
\includegraphics[scale=0.39]{Img/68b.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\vspace{-5mm}
\begin{center}
	\captionof{figure}{Cardioides}
	\begin{minipage}[t]{0.31\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/143.pdf}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}[t]{0.28\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/144.pdf}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}[t]{0.27\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/145.pdf}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Cardioide $\boldsymbol\alpha(t)=\langle 3+(1-\sin(t))\cos(t),(1-\sin(t))\sin(t)\rangle$}
	\begin{minipage}{0.38\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/146.pdf}
	\end{minipage}
...
\vskip0.2cm
\begin{center}
	\captionof{figure}{Toro cardiogénico construido a partir de $r=1-\sin(t)$}
	\begin{minipage}[t]{0.35\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/147.pdf}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}[t]{0.35\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Img/63a.eps}
	\end{minipage}
...
\begin{center}
	...
	\begin{minipage}[t]{0.34\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Img/63b.eps}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}[t]{0.34\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Img/63c.eps}
	\end{minipage}
...
\begin{center}
\captionof{figure}{Toro cardiogénico construido a partir de $r=1-\cos(t)$}
\vskip0.2cm
\includegraphics[scale=0.35]{Img/59a.eps}
\includegraphics[scale=0.30]{Img/59b.eps}
\includegraphics[scale=0.30]{Img/59c.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\captionof{figure}{Toro cardiogénico construido a partir de $r=1+\cos(t)$}
\vskip0.3cm
\includegraphics[width=0.3\linewidth,height=0.2\textheight]{Img/64a.eps}
\includegraphics[width=0.3\linewidth,height=0.2\textheight]{Img/64b.eps}
\includegraphics[width=0.3\linewidth,height=0.2\textheight]{Img/64c.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\includegraphics[scale=0.29]{Img/T_30a.eps}
\includegraphics[scale=0.33]{Img/T_30b.eps}
\includegraphics[scale=0.29]{Img/T_30c.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\normalfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\begin{center}
\captionof{figure}{Un paraboloide hiperbólico y un cilindro cardioidico}
\includegraphics[scale=0.36]{Img/T_31a.eps}
\includegraphics[scale=0.31]{Img/T_31b.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\normalfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\begin{center}
\captionof{figure}{Esfera y cilindro cardiológico}
\includegraphics[scale=0.35]{Img/T_32a.eps}
\includegraphics[scale=0.35]{Img/T_32b.eps}
\includegraphics[scale=0.35]{Img/T_32c.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\normalfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\begin{center}
\captionof{figure}{Superficie obtenida de girar $r=\sin(3\theta)$.}
\includegraphics[scale=0.28]{Img/99a.eps}
\includegraphics[scale=0.23]{Img/99b.eps}
\includegraphics[scale=0.25]{Img/99c.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\normalfont\textbf{Fuente:} elaboración propia.}
\end{center}
