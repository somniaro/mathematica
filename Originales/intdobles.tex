...
\includegraphics[scale=0.35]{Img/T_69c.pdf}
\includegraphics[scale=0.34]{Img/T_69b.pdf}
\includegraphics[scale=0.36]{Img/T_69a.pdf}
...
\includegraphics[scale=0.34]{Img/T_70a.pdf}
\includegraphics[scale=0.33]{Img/T_70b.pdf}
\includegraphics[scale=0.34]{Img/T_70c.pdf}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{11pt}\selectfont{\bf Fuente:} elaboración propia.}
\end{center}
...
\includegraphics[scale=0.32]{Img/T_68a.pdf}
\includegraphics[scale=0.30]{Img/T_68b.pdf}
\includegraphics[scale=0.30]{Img/T_68c.pdf}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{11pt}\selectfont{\bf Fuente:} elaboración propia.}
\end{center}
...
\begin{center}
	...
	\begin{minipage}{0.21\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/6g.pdf}
	\end{minipage}
	\hspace{0.02\linewidth}
	\begin{minipage}{0.21\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/6a.pdf}
	\end{minipage}
	\hspace{0.02\linewidth}
	\begin{minipage}{0.21\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/6b.pdf}
	\end{minipage}
...
\includegraphics[scale=0.18]{Img/6f.pdf}
\includegraphics[scale=0.20]{Img/6c.pdf}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\begin{center}
	...
	\begin{minipage}{0.21\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/6d.pdf}
	\end{minipage}
	\hspace{0.02\linewidth}
	\begin{minipage}{0.21\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/6e.pdf}
	\end{minipage}
	\hspace{0.02\linewidth}
...
\begin{center}
	...
	\includegraphics[width=0.23\linewidth]{Img/40a.pdf}
	\hspace{0.5cm} 
	\includegraphics[width=0.23\linewidth]{Img/40b.pdf}
...
\begin{center}
	...
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/39c.pdf}
	\end{minipage}
	\vspace{0.5em}
	\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\includegraphics[scale=0.30]{Img/55d.pdf}
\includegraphics[scale=0.29]{Img/55c.pdf}
\includegraphics[scale=0.29]{Img/55b.pdf}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\includegraphics[scale=0.32]{Img/57a.pdf}
\includegraphics[scale=0.32]{Img/57b.pdf}
\parbox{0.95\linewidth}{\centering\fontsize{8pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\includegraphics[scale=0.26]{Img/19a.pdf}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\begin{center}
	...
	\begin{minipage}[t]{0.30\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Img/20a.pdf}
	\end{minipage}
	\hfill
	\begin{minipage}[t]{0.30\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Img/20b.pdf}
	\end{minipage}
...
\begin{center}
	...
	\begin{minipage}[t]{0.26\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Img/21a.pdf}
	\end{minipage}
	\hfill
	\begin{minipage}[t]{0.26\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Img/21b.pdf}
	\end{minipage}
...
\begin{center}
	...
	\begin{minipage}[t]{0.30\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Img/48a.pdf}
	\end{minipage}
...
\begin{center}
\captionof{figure}{La flor $r=3\sin(3\theta)$ sobre una esfera}
\includegraphics[scale=0.39]{Img/68a.pdf}
\includegraphics[scale=0.39]{Img/68b.pdf}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\begin{center}
	...
	\begin{minipage}[t]{0.35\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Img/63a.pdf}
	\end{minipage}
...
\begin{center}
	...
	\begin{minipage}[t]{0.34\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Img/63b.pdf}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}[t]{0.34\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Img/63c.pdf}
	\end{minipage}
...
\vskip0.2cm
\includegraphics[scale=0.35]{Img/59a.pdf}
\includegraphics[scale=0.30]{Img/59b.pdf}
\includegraphics[scale=0.30]{Img/59c.pdf}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\captionof{figure}{Toro cardiogénico construido a partir de $r=1+\cos(t)$}
\vskip0.3cm
\includegraphics[width=0.3\linewidth,height=0.2\textheight]{Img/64a.pdf}
\includegraphics[width=0.3\linewidth,height=0.2\textheight]{Img/64b.pdf}
\includegraphics[width=0.3\linewidth,height=0.2\textheight]{Img/64c.pdf}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\includegraphics[scale=0.29]{Img/T_30a.pdf}
\includegraphics[scale=0.33]{Img/T_30b.pdf}
\includegraphics[scale=0.29]{Img/T_30c.pdf}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\normalfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\includegraphics[scale=0.36]{Img/T_31a.pdf}
\includegraphics[scale=0.31]{Img/T_31b.pdf}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\normalfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\includegraphics[scale=0.35]{Img/T_32a.pdf}
\includegraphics[scale=0.35]{Img/T_32b.pdf}
\includegraphics[scale=0.35]{Img/T_32c.pdf}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\normalfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\includegraphics[scale=0.28]{Img/99a.pdf}
\includegraphics[scale=0.23]{Img/99b.pdf}
\includegraphics[scale=0.25]{Img/99c.pdf}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\normalfont\textbf{Fuente:} elaboración propia.}
\end{center}
