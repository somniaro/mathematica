...
En la sección \ref{regionesparametrizadas} se presentaron algunas generalidades 
...
Si $x=f(t) $ y $y=g(t)$, el conjunto de puntos $(x,y)$ que satisfacen estas ecuaciones se denomina curva param\'{e}trica 
(o parametrizada) en $\mathbb{R}^2$ y las ecuaciones que la definen se denominan las ecuaciones param\'{e}tricas
...
\begin{figure}[H]
\begin{center}
	\captionof{figure}{\small Gráfico de $2z=x^{2}+y^{2}$ y $-x+y+z=1$.}
\includegraphics[scale=0.30]{Img/72a.eps} \hskip0.5cm
\includegraphics[scale=0.30]{Img/72b.eps}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{\small Gráfico de $x-y^{2}+4y-z^{2}+2z=2$ y $y^{2}-4y+4+z^{2}=4z.$}
	\begin{minipage}{0.26\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/70a.eps}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}{0.26\linewidth}
		\centering
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Gráfico de $x^{2}+y^{2}=4$ y $z=x^{2}-y^{2}$}
	\label{fig:67}
	\begin{minipage}{0.27\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/67a.eps}
	\end{minipage}
	\begin{minipage}{0.35\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/301.pdf}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{\small Gráfico de $z=x^2+y^2$ y $z=5-y^2$}
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/50a.eps}
	\end{minipage}
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/50b.eps}
	\end{minipage}
...
o tambi\'{e}n en la ecuación del cilindro
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{\small Gráfico de $x=z^{2}$ y $x=4y-y^{2}$}
	\begin{minipage}{0.23\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/53a.eps}
	\end{minipage}
	\begin{minipage}{0.23\linewidth}
		\centering
	...
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/53f.eps}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{\small Gráfico de $8y=9-5x^{2}-6z^{2}$ y $16y=4z^{2}-x^{2}$}
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/71c.eps}
	\end{minipage}
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/71a.eps}
	\end{minipage}
...
\begin{figure}[H]
	...
	\begin{minipage}[t]{0.34\linewidth}
		\centering
		\includegraphics[width=0.69\linewidth]{Img/1f.eps}
	\end{minipage}%
	\hspace{0.2em}
	\begin{minipage}[t]{0.34\linewidth}
		\centering
...
\begin{figure}[H]
\begin{center}
	\captionof{figure}{\small Gráfico de $2x^2+y^2=z^2+12$ y $x^2+y^2+8z^2=30$.}
\includegraphics[scale=0.40]{Img/87a.eps}
\includegraphics[scale=0.40]{Img/87b.eps}
\parbox{0.95\linewidth}{\centering\fontsize{8pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{minipage}[t]{0.38\linewidth}
		\centering
		\includegraphics[width=0.75\linewidth]{Img/6a.eps}
	\end{minipage}%
	\hspace{0.1em}
...
\vspace{0.8em} 
\begin{tcolorbox}[breakable,enhanced,title=\bf Instrucción \verb"Mathematica", top=2pt,bottom=2pt,boxsep=0pt,
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{\small $r=1-\cos t,$ $3z=4-4x-x^2-2y-y^2$}
	\begin{minipage}{0.27\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/58a.eps}
	\end{minipage}
	\begin{minipage}{0.26\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/58b.eps}
	\end{minipage}
...
%\noindent
\vskip0.7cm
\begin{enumerate}[leftmargin=0.5cm, labelsep=0.2cm, labelwidth=0.3cm, align=left, label=\bfseries\arabic*., series=ejercicios]
	\item \makebox[\linewidth][c]{$\overrightarrow{r}(t)=\la 3t^{3}+t,3t^{2},3t^{3}-t\ra, $ $t \in [-2,2].$}
\end{enumerate}
\vskip0.2cm
De las ecuaciones param\'{e}tricas se sigue que 
...
presentan a continuación y con \'{e}stos también se muestra la curva de intersección.
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{\small Superficies con intersección ${\bf r}(t)=\la 3t^{3}+t,3t^{2},3t^{3}-t\ra$}
	\begin{minipage}{0.27\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/94a.eps}
	\end{minipage}
	\begin{minipage}{0.24\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/94b.eps}
	\end{minipage}
...
\vskip0.7cm
\begin{enumerate}[resume=ejercicios, leftmargin=0.5cm, labelsep=0.2cm, labelwidth=0.3cm, align=left, label=\bfseries\arabic*.]
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{\small Superficies con intersección ${\bf r}(t)=\la \sqrt{t^{3}},\frac{9}{16}t,t^{2}\ra$}
	\begin{minipage}{0.22\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/92a.eps}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}{0.22\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/92b.eps}
	\end{minipage}
...
\begin{figure}[H]
\begin{center}
	\captionof{figure}{\small Superficies con intersección ${\bf r}(t)=\la 4t^{3}+2t^{2},\frac{4}{3\sqrt{2}}t,4t^{3}-2t^{2}\ra$.}
\includegraphics[scale=0.40]{Img/93a.eps} \hskip0.5cm
\includegraphics[scale=0.36]{Img/93b.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
\end{figure}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{\small Superficies con intersección ${\bf r}(t)=\la 3t-t^{3},3t^2,3t+t^{3} \ra$}
	\begin{minipage}{0.22\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/91a.eps}
	\end{minipage}
	\hskip0.5cm
	\begin{minipage}{0.22\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/91b.eps}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{\small Superficies con intersección ${\bf r}(t)=\la \sec t, \ln (\sec(t)+\tan(t)),\tan(t) \ra$}
	\begin{minipage}{0.24\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/95a.eps}
	\end{minipage}
	\begin{minipage}{0.24\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/95b.eps}
	\end{minipage}
...
\begin{figure}[H]
\begin{center}
\captionof{figure}{\small Gráfico de $x^2+z^2=4y^2+\frac{1}{2}$ y $x^2+z^2=1-y$.}
\includegraphics[scale=0.26]{Img/T_23a.eps}\hskip0.5cm
\includegraphics[scale=0.26]{Img/T_23b.eps} 
\parbox{0.95\linewidth}{\centering\fontsize{8pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\captionof{figure}{\small Gráfico de $x^2+z^2-2x=y^2-2$ y $3x^2+2z^2-4z=34$.}
\includegraphics[scale=0.30]{Img/T_24a.eps}\hskip0.5cm
\includegraphics[scale=0.30]{Img/T_24b.eps} 
\parbox{0.95\linewidth}{\centering\fontsize{8pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\captionof{figure}{\small Gráfico de $x^2+y^2+z^2-2x=31$ y $x^2+y^2+2x=4z-1$.}
\includegraphics[scale=0.33]{Img/T_25a.eps}\hskip0.5cm
\includegraphics[scale=0.35]{Img/T_25b.eps} 
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\captionof{figure}{\small Gráfico de $r=1+\cos(t)$ y $x+y+3z=1.$}
\includegraphics[scale=0.30]{Img/T_29a.eps}\hskip0.25cm
\includegraphics[scale=0.34]{Img/T_29b.eps} 
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\captionof{figure}{\small Gráfico de $x^2 + y^2 + z^2 - 2 x = 4$ y $x^2 + y^2 + z^2 - 2z = 4.$}
\includegraphics[scale=0.30]{Img/T_72a.eps}\hskip0.5cm
\includegraphics[scale=0.30]{Img/T_72b.eps} 
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\captionof{figure}{\small Gráfico de $r=\sin(2\theta)$ y $x+y+3z=1$.}
\includegraphics[scale=0.25]{Img/97a.eps}\hskip0.5cm
\includegraphics[scale=0.25]{Img/97b.eps} 
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\captionof{figure}{\small Gráfico de $r=\sin(2\theta)$ y $z=1-x^2-y^2$.}
\includegraphics[scale=0.28]{Img/98a.eps}\hskip0.5cm
\includegraphics[scale=0.33]{Img/98b.eps} 
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
\end{figure}
...
\begin{Verbatim}
a=ParametricPlot3D[{{Sqrt[3/2]*Cos[t],-1/2,Sqrt[3/2]*Sin[t]},
{Sqrt[3]/2*Cos[t],1/4,Sqrt[3]/2*Sin[t]}},{t,0,2*Pi},
PlotStyle->{Directive[Black,Thickness->0.015],
Directive[Black,Thickness->0.015]}];

b=ContourPlot3D[{x^2+z^2==4*y^2+1/2,x^2+z^2==1-y},
{x,-5/2,5/2},{y,-1.2,1.2},{z,-5/2,5/2},PlotPoints->90,
Mesh->False,ContourStyle->{Directive[Orange,Opacity[0.8]],
Directive[RGBColor[0.5,0.8,0.5],Opacity[0.8]]}]
...
\begin{comment}
\begin{Verbatim}
A=ContourPlot3D[{x^2+z^2-2x==y^2-2,3*x^2+2*z^2-4*z==34},
{x,-7,9},{y,-7,7},{z,-7,8},Mesh->False,
ContourStyle->{Orange,Blend[{Green,Yellow},0.6]},
PlotPoints->90];
x=2*Sqrt[3]*Cos[t];
z=3*Sqrt[2]*Sin[t]+1;
y=Simplify[Sqrt[x^2+z^2-2x+2]];
B=ParametricPlot3D[{{x,y,z},{x,-y,z}},{t,0,2*Pi},
PlotStyle->{Directive[Black,Thickness->0.012],
Directive[Black,Thickness->0.012]},PlotPoints->90];
Show[A,B]
\end{Verbatim}
\end{comment}
...
\begin{comment}
\begin{Verbatim}
A = ContourPlot3D[{y^2 + z^2 - 2*x + x^2 == 31,x^2 + y^2 + 2 x == 4*z - 1},
{x, -6.32, 7}, {y, -7, 7}, {z, -6, 7}, Mesh -> False, ContourStyle -> {Orange,
Blend[{Green, Yellow}, 0.4]}, PlotPoints -> 90, BoxRatios -> {1, 1, 1}];

x = t^2/4 - 9;
z = t - 2;
y = Simplify[Sqrt[4*z - 1 - x^2 - 2*x]];
B = ParametricPlot3D[{{x, y, z}, {x, -y, z}}, {t, 4.422, 7.072}, 
PlotStyle -> {Directive[Black, Thickness -> 0.017], Directive[Black,Thickness -> 0.017]}];
Show[A, B]
\end{Verbatim}
\end{comment}
...
{t,0,2Pi},{u,-1,1},Mesh->False,PlotStyle->Orange];
c=ContourPlot3D[x+y+3*z==1,{x,-2,3},{y,-2.5,3},{z,-1.3,2},
Mesh->False,ContourStyle->Cyan];
x=(1+Cos[t])Cos[t];
y=(1+Cos[t])*Sin[t];
z=(1-x-y)/3;
b=ParametricPlot3D[{{(1+Cos[t])Cos[t],(1+Cos[t])*Sin[t],
z},{(1+Cos[t])Cos[t],(1+Cos[t])*Sin[t],1}},{t,0,2Pi},
PlotStyle->Black];
Show[a,b,c,PlotRange->{{-1,2},{-2,2},{-1,1.35}}]
\end{Verbatim}
\end{comment}

\begin{comment}
{x,y}={Sin[2*t]*Cos[t],Sin[2*t]*Sin[t]};
z=(1-x-y)/3;
a=ParametricPlot3D[{x,y,u},{t,0,2Pi},{u,-1.1,1.35},Mesh->False,PlotStyle->Yellow,PlotPoints->60];
c=ContourPlot3D[x+y+3*z==1,{x,-1.5,1.5},{y,-1.5,1.5},{z,-1.1,1.35},Mesh->False,ContourStyle->Green];
b=ParametricPlot3D[{{x,y,z},{x,y,1.35}},{t,0,2*Pi},PlotStyle->Black,PlotPoints->90];
Show[c,b,a,BoxStyle->Directive[Dashed]]
\end{comment}
...
\begin{comment}
{x,y}={Sin[2*t]*Cos[t],Sin[2*t]*Sin[t]};
a=ParametricPlot3D[{x,y,u},{t,0,2Pi},{u,-1.1,1.5},Mesh->False,PlotStyle->Yellow,PlotPoints->60];
c=ContourPlot3D[z==1-x^2-y^2,{x,-1.5,1.5},{y,-1.5,1.5},{z,-1.1,1.5},Mesh->False,ContourStyle->Yellow];
z=1-x^2-y^2;
b=ParametricPlot3D[{{x,y,z},{x,y,1.5}},{t,0,3*Pi},PlotStyle->Black,PlotPoints->90];
Show[c,b,a,BoxStyle->Directive[Dashed]]
\end{comment}
