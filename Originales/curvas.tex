...
\begin{figure}[H]
\centering
\caption{\small Gráfico de $x-y^{2}+4y-z^{2}+2z=2$ y $y^{2}-4y+4+z^{2}=4z.$}
...
\begin{figure}[H]
\centering
\caption{\small Gráfico de $z=x^2+y^2$ y $z=5-y^2$}
...
\begin{figure}[H]
\centering
\caption{\small Gráfico de $x=z^{2}$ y $x=4y-y^{2}$}
...
\begin{figure}[H]
\centering
\caption{\small Gráfico de $8y=9-5x^{2}-6z^{2}$ y $16y=4z^{2}-x^{2}$}
...
\begin{figure}[H]
\centering
\caption{\small $r=1-\cos t,$ $3z=4-4x-x^2-2y-y^2$}
...
\begin{figure}[H]
\centering
\caption{\small Superficies con intersección ${\bf r}(t)=\la 3t^{3}+t,3t^{2},3t^{3}-t\ra$}
...
\begin{figure}[H]
\centering
\caption{\small Superficies con intersección ${\bf r}(t)=\la \sqrt{t^{3}},\frac{9}{16}t,t^{2}\ra$}
...
\begin{figure}[H]
\centering
\caption{\small Superficies con intersección ${\bf r}(t)=\la 3t-t^{3},3t^2,3t+t^{3} \ra$}
...
\begin{figure}[H]
\centering
\caption{\small Superficies con intersección ${\bf r}(t)=\la \sec t, \ln (\sec(t)+\tan(t)),\tan(t) \ra$}
