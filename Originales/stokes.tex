\chapter{Integración de campos vectoriales}

Los campos vectoriales se presentaron con algunas generalidades en la sección \ref{funcionesenelespacio}. \label{integracioncamposvectoriales}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Curva en $\mathbb{R}^2$}
	\begin{minipage}{0.35\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/170.pdf}
	\end{minipage}
...
$\mathbf{F}(\mathbf{r}(t))$ sobre la curva $C$ desde el punto $A_{i-1}$ hasta $A_i$. Por tanto, el trabajo realizado por $\mathbf{F}$ para trasladar una partícula desde $A_{i-1}$ hasta $A_i$ está dado por:
{\small
\begin{multline*}
\Delta W_i =
\left\langle
...
\end{eqnarray*}
Por tanto, si ${\bf F}$ es un campo gradiente, entonces la circulación de ${\bf F}$ a lo largo de toda curva dentro del dominio de ${\bf F}$ solo depende de los puntos extremos de dicha curva.
\vskip0.2cm
\begin{ejemplo}
...
sobre la curva $\alpha$ parametrizada por ${\bf r}(t)=\langle 2 t-1,t+2,9 t^2 \rangle$ con $t \in [-1,2].$ \vskip0.2cm
\noindent
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/171.png}
	\end{minipage}
...
\begin{center}
\captionof{figure}{La razón del flujo a través de cada lado en la dirección indicada}
\includegraphics[width=0.5\linewidth]{Fig/173.pdf}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
\vskip0.2cm
...
Por tanto, el flujo a través de la frontera del rectángulo $R$ es aproximadamente
...
Estos elementos se presentaron en la sección (\ref{divergenciayrotacional}).
...
\vskip0.2cm
\begin{ejemplo}
Calcular la circulación en sentido antihorario  y el flujo hacia afuera del campo
...
Por tanto ${\bf F}({\bf r}(t))=\left\langle \left( \sin 2t+3\sqrt{2}\right) \cos t,4\sqrt{2}\cos ^{3}t-\sin t\right\rangle,$ además
...
= \frac{5}{2}\sqrt{2}\pi  \end{multline*}
...
\begin{ejemplo}
Considere el campo vectorial \[{\bf F}(x,y)=\left\langle x^{2}-\frac{x}{1+y^{2}},e^{x}+\arctan y\right\rangle ,\]
...
Seg\'{u}n \textcite{marsden_calculo_2013}, una superficie parametrizada es una función ${\bf r}:D\subset \mathbb{R}^{2}\rightarrow \mathbb{R}^{3},$ en donde $D$ es alg\'{u}n dominio en $\mathbb{R}^{2};$ la superficie $\sigma $ correspondiente a la función ${\bf r}$ es su imagen $\sigma ={\bf r}\left( D\right) ,$ que se escribe como  
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Campo vectorial ${\bf r}_u \times {\bf r}_v$ sobre la esfera}
	\begin{minipage}{0.35\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/174.pdf}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Campo vectorial ${\bf r}_u \times {\bf r}_v$ sobre la superficie $4z=xy$}
	\begin{minipage}{0.45\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/175.pdf}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Campo vectorial  ${\bf r}_u \times {\bf r}_v$}
	\begin{minipage}{0.43\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/176.pdf}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Cinta de Mobius}
	\begin{minipage}{0.40\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/177.pdf}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Campo vectorial ${\bf r}_x \times {\bf r}_y$ sobre el hiperboloide}
	\begin{minipage}{0.40\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/178.pdf}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.40\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/179.pdf}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{La botella de Klein}
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/180.pdf}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Campo vectorial ${\bf r}_u \times {\bf r}_v$ sobre el paraboloide}
	\begin{minipage}{0.41\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/181.pdf}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Campo vectorial ${\bf r}_u \times {\bf r}_v$ sobre el toro}
	\begin{minipage}{0.39\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/182.pdf}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Superficie sobre el paraboloide interior al cilindro}
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/70b.eps}
	\end{minipage}
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_22a.eps}
	\end{minipage}
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_22b.eps}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{$2z\leq x^2+y^2$ \& $z \leq 1+x-y$}
	\begin{minipage}{0.20\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/72a.eps}
	\end{minipage}
	\begin{minipage}{0.20\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_26a.eps}
	\end{minipage}
	\begin{minipage}{0.20\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_26b.eps}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Superficie $S$ sobre una esfera}
	\begin{minipage}{0.34\linewidth}
		\centering
		\vspace{-2mm}
		\includegraphics[width=\linewidth]{Fig/183.pdf}
	\end{minipage}
	\begin{minipage}{0.34\linewidth}
		\centering
		\vspace{-2mm}
		\includegraphics[width=\linewidth]{Fig/184.pdf}
	\end{minipage}
...
La superficie $S$ es una parte de la esfera de radio $1$ con centro en el punto  $(1,0,0),$ por tanto, usaremos coordenadas esféricas en la forma $x=\rho \cos \phi ,$ $y=\rho \cos \theta \sin \phi ,$
...
\begin{center}
\captionof{figure}{Campo vectorial ${\bf F}$ sobre la superficie $S$}
\includegraphics[scale=0.27]{Img/T_18a.eps}
\includegraphics[scale=0.27]{Img/T_18b.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Superficie sobre el elipsoide}
	\begin{minipage}{0.38\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/185.pdf}
	\end{minipage}
...
\begin{center}
\captionof{figure}{Campo vectorial ${\bf F}(x,y,z)=\la 2x,2y,z\ra$ sobre la superficie $S$}
\includegraphics[scale=0.27]{Img/T_4a.eps}
\includegraphics[scale=0.27]{Img/T_4b.eps}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{$z=3-x^2-y^4+2y^2$ y su proyección en el plano $xy$}
	\begin{minipage}{0.30\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/186.pdf}
	\end{minipage}
	\begin{minipage}{0.30\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Fig/187.pdf}
	\end{minipage}
...
\vskip0.2cm
Se muestra a continuación el gráfico del sólido y la representación de los campos vectoriales $\la -1,0,-2z\ra$ y  $\la 1,-4+2y,0\ra,$ que determinan la orientación hacia afuera de la superficie.
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{$x = z^2$ con $(y-2)^2+z^2 \leq 4$}
	\begin{minipage}{0.24\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/53e.eps}
	\end{minipage}
	\begin{minipage}{0.26\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/53h.eps}
	\end{minipage}
	\begin{minipage}{0.26\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/53g.eps}
	\end{minipage}
...
\subsubsection*{Integración sobre el cilindro $x=z^{2}$}
...
\subsubsection*{Integración sobre el cilindro $x=4y-y^{2}$}

Sobre esta región se satisface que
$y= (2+2u\cos v)$ y $z=2u\sin v$ por tanto $x=4-2u^{2}\left( 1+\cos 2v\right);$
por tanto, la superficie se parametriza utilizando la función
\[{\bf r}\left( u,v\right) =\left\langle 4-2u^{2}\left( 1+\cos 2v\right) ,2+2u\cos v,2u\sin v\right\rangle,\]
con $u\in[0,1],\, v\in [0,2\pi].$
Por tanto, $\rot{F}\left({\bf r}\left( u,v\right)\right) =\big \langle -2u\cos v-3,-2u\sin v,-4u\cos v-5\big \rangle.$
...
= -12\pi
\end{equation}
De acuerdo con el teorema de Stokes, se buscará la igualdad de los planteamientos que conducen a los resultados obtenidos en \ref{stokes6}, \ref{stokes7} y \ref{stokes8}. \vskip0.2cm
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{$z=(x+y^2)e^{1-x^2-y^2}$}
	\begin{minipage}{0.28\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_33a.eps}
	\end{minipage}
	\begin{minipage}{0.28\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_33c.eps}
	\end{minipage}
	\begin{minipage}{0.28\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_33b.eps}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Campo vectorial ${\bf F}$ sobre la superficie $z=\ln (x^2+y^2)$}
	\begin{minipage}{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_5a.eps}
	\end{minipage}
	\begin{minipage}{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_5b.eps}
	\end{minipage}
...
\subsection*{Flujo sobre la superficie \texorpdfstring{$z=xe^{1-x^2-y^2}$}{z=xe^{1-x2-y2}}}
...
\vskip0.2cm
\begin{center}
\captionof{figure}{Campo vectorial ${\bf F}$ sobre la superficie $z=xe^{1-x^2-y^2}$} 
\includegraphics[scale=0.31]{Img/T_6b.eps}
\includegraphics[scale=0.31]{Img/T_6a.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.} \end{center}
\vskip0.2cm
...
\begin{center}
\captionof{figure}{Campo vectorial ${\bf F}(x,y,z)= \la xz,y,x \ra$ sobre el elipsoide} 
\includegraphics[scale=0.35]{Img/T_1a.eps}
\includegraphics[scale=0.35]{Img/T_1b.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.} 
\end{center}
...
\begin{center}
\captionof{figure}{Campo vectorial ${\bf F}(x,y,z)= \la xz,x(y+1),z(y+1) \ra$ sobre el paraboloide} 
\includegraphics[scale=0.33]{Img/T_2a.eps}
\includegraphics[scale=0.33]{Img/T_2b.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.} 
\end{center}
...
\]
por tanto, el flujo sobre la superficie en mención es
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Superficies $9y=3-9x^{2}-4z^{2}+4z$ y $4z-9y=9$}
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_T1.eps}
	\end{minipage}
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_T2.eps}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Campo vectorial ${\bf F}(x,y,z)= \la xz,x(y+1),z(y+1) \ra$ sobre la superficie $E$}
	\begin{minipage}{0.28\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_21a.eps}
	\end{minipage}
	\begin{minipage}{0.28\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_21b.eps}
	\end{minipage}
	\begin{minipage}{0.28\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_21c.eps}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Campo vectorial ${\bf F}(x,y,z)= \la y^2,-xy,z \ra$ sobre una esfera}
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_3a.eps}
	\end{minipage}
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_3b.eps}
	\end{minipage}
...
\begin{minipage}{\textwidth}
	\centering
	\captionof{figure}{Campo vectorial ${\bf F}(x,y,z)=\la y^2,x^2,z\ra $ sobre una superficie}
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_8b.eps}
	\end{minipage}
	\begin{minipage}{0.25\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_8d.eps}
	\end{minipage}
...
\subsubsection*{Flujo sobre el paraboloide $\bm{\mathsf{2z=6-2x^2-y^2}}$}
...
\subsubsection*{Flujo sobre el paraboloide $\bm{\mathsf{z+3=x^2+y^2}}$}
...
\begin{center}
%\vspace{30mm}
\captionof{figure}{${\bf F}(x,y,z) = \la y,-x,z \ra$ sobre la superficie $x^2+y^2\leq 4$ \& $x^2+y^2+z^2\leq 9$}
\includegraphics[scale=0.28]{Img/T_9b.eps}
\includegraphics[scale=0.28]{Img/T_9c.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
\begin{center}
\captionof{figure}{Campo vectorial ${\bf F}(x,y,z)=\la z,y,x\ra$}
\includegraphics[scale=0.34]{Img/T_11c.eps}\hskip0.2cm
\includegraphics[scale=0.34]{Img/T_11d.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
\vskip0.2cm
...
\vskip0.2cm
\begin{center}
\captionof{figure}{Parametrización de la superficie del sólido}  
\includegraphics[scale=0.31]{Img/T_11e.eps}\hskip0.5cm
\includegraphics[scale=0.38]{Img/T_11f.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}  
\end{center}
\vskip0.2cm
...
\vskip0.2cm
\begin{center}
\captionof{figure}{Campo vectorial ${\bf F}(x,y,z)=\la 3x,y,3z\ra$} 
\includegraphics[width=4.3cm,height=4.1cm]{Img/T_10c.eps}
\includegraphics[width=4.3cm,height=4.1cm]{Img/T_10d.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.} 
\end{center}
\vskip0.2cm
...
$v\in \lbrack 0,2\pi ].$ \vskip 0.2cm
...
\vskip0.3cm
\begin{center}
\captionof{figure}{Campo vectorial ${\bf F}(x,y,z)=\la y,-x,z\ra$, sobre $x^2+y^2+z^2=9 $ \& $r=1+\cos \theta$}
\includegraphics[scale=0.27]{Img/T_12c.eps}
\includegraphics[scale=0.27]{Img/T_12d.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.} 
\end{center}
\vskip0.3cm
Las instrucciones que permiten obtener este gráfico son las siguientes.
...
\vskip0.2cm
\begin{center}
\captionof{figure}{Campo vectorial ${\bf F}(x,y,z) = \la x,1,y+z \ra $ }
\includegraphics[scale=0.30]{Img/T_14c.eps}
\includegraphics[scale=0.30]{Img/T_14d.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
\vskip0.2cm
...
$x^{2}+z^{2}=\frac{9}{2}.$ Por tanto, la porción del cono se parametriza como
...
\vskip0.2cm
\begin{center}
\captionof{figure}{Campo vectorial ${\bf F}(x,y,z)=\la x,y,2z \ra$} 
\includegraphics[scale=0.29]{Img/T_13b.eps}
\includegraphics[scale=0.29]{Img/T_13c.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}  
\end{center}
\vskip0.2cm
...
\begin{center}
\captionof{figure}{Campo vectorial ${\bf F}(x,y,z)=\la x,y,z\ra$ sobre $4y=x^2+z^2$ \& $x^2+y^2+z^2=12$}
\includegraphics[scale=0.26]{Img/T_15c.eps} \hspace{0.5cm}
\includegraphics[scale=0.34]{Img/T_15d.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
...
Por tanto, ${\bf F}({\bf r}(u,v)) = \langle \sqrt{8}u \cos v ,\sqrt{12-8u^2} ,\sqrt{8}u\sin v \rangle$ y
...
\vskip0.6cm
\begin{center}
\captionof{figure}{Campo vectorial ${\bf F}(x,y,z)=\la x-2,z,-y \ra$ sobre una superficie}
\includegraphics[scale=0.33]{Img/T_17d.eps}
\includegraphics[scale=0.28]{Img/T_17e.eps}
\includegraphics[scale=0.33]{Img/T_17c.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}
\end{center}
\vskip0.2cm
...
\vskip0.2cm
\begin{center}
\captionof{figure}{${\bf F}(x,y,z)=\la yz,y-xz,xy\ra $ sobre $x+3=y^2+z^2$ \& $y^2-z^2=9x-3$} 
\includegraphics[scale=0.31]{Img/T_16d.eps}
\includegraphics[scale=0.31]{Img/T_16e.eps}
\includegraphics[scale=0.31]{Img/T_16f.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.} 
\end{center}
\vskip0.2cm
...
\begin{enumerate}[font=\normalfont,leftmargin=1.2em, itemindent=0pt,      labelwidth=\labelwidth,labelsep=0.5em,]
...
\vskip0.3cm
\begin{center}
\captionof{figure}{${\bf F}(x,y,z)=\la x-2y,3x+y,z+1\ra$ sobre un hiperboloide}
\includegraphics[width=3cm,height=3cm]{Img/T_35a.eps}
\includegraphics[width=3cm,height=3cm]{Img/T_35b.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\normalfont\textbf{Fuente:} elaboración propia.} 
\end{center}
\begin{comment}
datos=Table[{x-2*y,3*x+y,z+1},{z,-2,2},{y,-2,2},{x,-2,2}];
ListSliceVectorPlot3D[datos,ImplicitRegion[x^2+y^2-z^2==1,{x,y,z}],
DataRange->{{-2,2},{-2,2},{-7/4,7/4}},VectorPoints->16,
VectorStyle->{Thickness->0.006,Black,Thickness->0.005}]
\end{comment}
\clearpage
%\vskip0.2cm
...
\begin{center}
\captionof{figure}{Superficie sobre un paraboloide} 
\includegraphics[width=4.2cm,height=3cm]{Img/T_36a.eps}
\includegraphics[width=4.2cm,height=3cm]{Img/T_36b.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\normalfont\textbf{Fuente:} elaboración propia.} 
\end{center}
\vskip0.3cm
...
%\vspace{15mm}
\begin{center}
\captionof{figure}{Campo vectorial ${\bf F}(x,y,z)= \la x-2,y,2z\ra $ sobre un paraboloide} 
\includegraphics[width=4.0cm,height=3cm]{Img/T_36c.eps}
\includegraphics[width=4.0cm,height=3cm]{Img/T_36d.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\normalfont\textbf{Fuente:} elaboración propia.}
\end{center}
\vskip0.4cm
...
\begin{center}
\captionof{figure}{Campo vectorial ${\bf F}(x,y,z)= \la z-y,y,z^2\ra $ sobre una silla de montar} 

\includegraphics[scale=0.25]{Img/T_37a.eps}
\includegraphics[scale=0.25]{Img/T_37b.eps}
\parbox{\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\normalfont\textbf{Fuente:} elaboración propia.} \end{center}
