...
\chapter{Sólidos de revolución en \\ coordenadas paramétricas}
...
\subsection*{Longitud de una curva en coordenadas paramétricas}
...
\subsection*{Volumen de sólidos de revolución en coordenadas \\ paramétricas}
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.26\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_74a.eps}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}{0.26\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_74b.eps}
	\end{minipage}
	\hspace{1em}
	\begin{minipage}{0.26\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_74c.eps}
	\end{minipage}
...
\section*{Coordenadas curvilíneas en el plano} \index{Coordenadas curvilíneas}
...
\subsection*{Coordenadas bipolares} \index{Coordenadas!bipolares}
...
\subsection*{Coordenadas elípticas} \index{Coordenadas!elípticas}
...
\subsection*{Coordenadas curvilíneas en el espacio} \index{Coordenadas!curvilíneas en el espacio}
Algunos ejemplos de los presentados en esta sección son una extensión de 
las respectivas coordenadas en el plano.

\subsubsection*{Coordenadas cilíndricas elípticas} 
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.28\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_63a.eps}
	\end{minipage}
	\begin{minipage}{0.30\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_63b.eps}
	\end{minipage}
...
\subsection*{Coordenadas cil\'{\i}ndricas parab\'{o}licas}  \index{Coordenadas!cilíndricas parab\'{o}licas}
...
\centering
\includegraphics[width=4.5cm,height=3.5cm]{Img/T_66a.eps}
\includegraphics[width=4cm,height=3.5cm]{Img/T_66b.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}  
\end{figure}
...
\subsection*{Coordenadas parab\'{o}licas} \index{Coordenadas!parab\'{o}licas}
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_64a.eps}
	\end{minipage}
	\begin{minipage}{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{Img/T_64b.eps}
	\end{minipage}
...
\subsection*{Coordenadas cilíndricas bipolares} \index{Coordenadas!cilíndricas bipolares}
...
\begin{minipage}{\textwidth}
	...
	\begin{minipage}{0.27\linewidth}
		\centering
		\vspace{-2mm}
		\includegraphics[width=\linewidth]{Img/T_65a.eps}
	\end{minipage}
	\begin{minipage}{0.27\linewidth}
		\centering
		\vspace{-2mm}
		\includegraphics[width=\linewidth]{Img/T_65b.eps}
	\end{minipage}
...
\subsection*{Coordenadas toroidales} \index{Coordenadas!toroidales}
\subsubsection*{Construcción de un toro}
...
\begin{figure}[H] 
	...
	\includegraphics[width=0.30\textwidth]{Img/T_57a.eps}
	\includegraphics[width=0.30\textwidth]{Img/T_57b.eps}
...
\subsection*{Coordenadas esferoidales oblatas.} \index{Coordenadas!esferoidales oblatas}
...
\vspace{-2mm}
\includegraphics[width=3cm,height=3.9cm]{Img/T_58a.eps}
\vspace{-2mm}
\includegraphics[width=3cm,height=3.9cm]{Img/T_58b.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}  
\end{figure}
\vspace{-3mm}
...
\subsection*{Coordenadas esferoides prolatas} \index{Coordenadas!esferoides prolatas}
...
\includegraphics[width=4cm,height=4cm]{Img/T_59a.eps}
\includegraphics[width=4cm,height=4cm]{Img/T_59b.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}  
\end{figure}
...
\subsection*{Coordenadas c\'{o}nicas} \index{Coordenadas!c\'{o}nicas}
...
\subsection*{Coordenadas biesf\'{e}ricas} \index{Coordenadas!biesf\'{e}ricas}
...
\centering
\captionof{figure}{\small Superficies constantes en coordenadas esferoidales prolatas.}
\includegraphics[width=4.2cm,height=3.8cm]{Img/T_60a.eps}
\includegraphics[width=4.2cm,height=3.8cm]{Img/T_60b.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}  
\end{figure}
Con las siguientes instrucciones se obtienen estas figuras:
...
\subsection*{Coordenadas cardioidicas} \index{Coordenadas!cardioidicas}
...
\centering
\captionof{figure}{\small Superficies constantes en coordenadas esferoidales prolatas.}  
\includegraphics[width=4cm,height=4.75cm]{Img/T_61a.eps}
\includegraphics[width=3cm,height=4.3cm]{Img/T_61b.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}  
\end{figure}
...
\subsection*{Coordenadas elipsoidales.} \index{Coordenadas!elipsoidales}
...
\subsection*{Coordenadas esf\'{e}ricas y cil\'{\i}ndricas} \index{Coordenadas!esféricas} \index{Coordenadas!cilíndricas}
...
\includegraphics[scale=0.34]{Img/T_62a.eps}
\includegraphics[width=3cm,height=3.6cm]{Img/T_62b.eps}
\includegraphics[scale=0.4]{Img/T_62c.eps}
\parbox{0.95\linewidth}{\centering\fontsize{9pt}{10pt}\selectfont\textbf{Fuente:} elaboración propia.}   
\end{figure}
